...
! Input Fixed Chapman
   REAL(8), dimension (0:WRAP_MAXLAYERS) :: TS_HEIGHT_GRID
   REAL(8), dimension (0:WRAP_MAXLAYERS) :: TS_PRESSURE_GRID
   REAL(8), dimension (0:WRAP_MAXLAYERS) :: TS_TEMPERATURE_GRID
   INTEGER,   dimension (WRAP_MAXLAYERS)   :: TS_FINEGRID
   REAL(8) :: TS_RFINDEX_PARAMETER

! Input fixed Optical

   REAL(8), dimension ( WRAP_MAXLAYERS ) :: TS_DELTAU_VERT_INPUT
   REAL(8), dimension ( 0:WRAP_MAXMOMENTS_INPUT, WRAP_MAXLAYERS ) :: TS_PHASMOMS_TOTAL_INPUT
   REAL(8), dimension ( WRAP_MAXLAYERS, WRAP_MAX_GEOMETRIES ) :: TS_PHASFUNC_INPUT_UP
   REAL(8), dimension ( WRAP_MAXLAYERS, WRAP_MAX_GEOMETRIES ) :: TS_PHASFUNC_INPUT_DN
   REAL(8) :: TS_LAMBERTIAN_ALBEDO
   REAL(8), dimension ( 0:WRAP_MAXLAYERS ) :: TS_THERMAL_BB_INPUT
...
! Input Modified User Values
   ...
   REAL(8), dimension (WRAP_MAX_USER_RELAZMS) :: TS_USER_RELAZMS
   INTEGER                                 :: TS_N_USER_STREAMS
   REAL(8), dimension (WRAP_MAX_USER_STREAMS) :: TS_USER_ANGLES_INPUT
   REAL(8), dimension (WRAP_MAX_USER_LEVELS)  :: TS_USER_LEVELS
   REAL(8)                               :: TS_GEOMETRY_SPECHEIGHT
   INTEGER                                 :: TS_N_USER_OBSGEOMS
   REAL(8), dimension (WRAP_MAX_USER_OBSGEOMS,3) :: TS_USER_OBSGEOMS_INPUT
   INTEGER                                   :: TS_N_USER_DOUBLETS
   REAL(8), dimension (WRAP_MAX_USER_STREAMS,2) :: TS_USER_DOUBLETS
...
! Input Modified Optical
   ...
   REAL(8), dimension ( WRAP_MAXLAYERS ) :: TS_OMEGA_TOTAL_INPUT

! Input Fixed Lin Control

   LOGICAL, dimension(WRAP_MAXLAYERS)  :: TS_LAYER_VARY_FLAG
   INTEGER, dimension(WRAP_MAXLAYERS)  :: TS_LAYER_VARY_NUMBER
   INTEGER  :: TS_N_TOTALCOLUMN_WFS
   INTEGER  :: TS_N_SURFACE_WFS
   INTEGER  :: TS_N_SLEAVE_WFS
   CHARACTER (LEN=31), dimension(WRAP_MAX_ATMOSWFS) :: TS_COLUMNWF_NAMES
   CHARACTER (LEN=31), dimension(WRAP_MAX_ATMOSWFS) :: TS_PROFILEWF_NAMES

! Input Lin Fixed Optical

   REAL(8), dimension(WRAP_MAX_ATMOSWFS,WRAP_MAXLAYERS) :: TS_L_DELTAU_VERT_INPUT
   REAL(8), dimension(WRAP_MAX_ATMOSWFS,WRAP_MAXLAYERS) :: TS_L_OMEGA_TOTAL_INPUT
   REAL(8), dimension(WRAP_MAX_ATMOSWFS,0:WRAP_MAXMOMENTS_INPUT,WRAP_MAXLAYERS) :: TS_L_PHASMOMS_TOTAL_INPUT
   REAL(8) :: TS_L_PHASFUNC_INPUT_UP ( WRAP_MAX_ATMOSWFS, WRAP_MAXLAYERS, WRAP_MAX_GEOMETRIES )
   REAL(8) :: TS_L_PHASFUNC_INPUT_DN ( WRAP_MAX_ATMOSWFS, WRAP_MAXLAYERS, WRAP_MAX_GEOMETRIES )
